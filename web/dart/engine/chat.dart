...
class TabContent
{
	...
	final _chatServerUrl = "ws://vps.robertmcdermot.com:8080";//"ws://couserver.herokuapp.com";
	...
	void _addmessage(Map map)
	{
		...
		if(chat.getPlayMentionSound() && map["message"].toLowerCase().contains(chat.username.toLowerCase()) && app.volume > 0)
		{
