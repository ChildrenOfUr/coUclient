...
resize()
{
	...
	//approx 960px wide is the minimum width for the window to show everything well
	...
	if(window.innerWidth < 960 || window.innerHeight < 325)
		warningMessage.hidden = false;
	else
		warningMessage.hidden = true;

	if(window.innerWidth < 960)
		warningMessage.text = "Warning, the window should be at least 960px wide to display the game well.";
	if(window.innerHeight < 325)
		warningMessage.text = "Warning, the window should be at least 325px high to display the game well.";
	if(window.innerWidth < 960 && window.innerHeight < 325)
		warningMessage.text = "Warning, the window should be at least 960px wide and 325px high to display the game well.";
}
